...
*/
  ...
  const punchClause1 = ["What goes up", "He who talks", "Janice's smile'", "The judge", "When there's no money, John", "If it doesn't stink, your mother", "Your mother always", "When we play games, the boss", "A drunks drink and", "The muscles", "Better when the bartender", "He who stands still", "It depends on who", "A higher jumper", "If he looks the part, then my cat", "Don't ask me because she", "You can take my wife and he"];
  const punchClause2 = ["reeks of guilt", "lands in bath water", "belongs to coworkers", "burps their way to the top", "drives a clown car", "must be a big screen television", "is better known as Mother Hubbard", "needs you", "has money to give me", "has the biggest truck", "finished last, they said","fits the pants", "knows where to hide", "can reassemble the burnt dinner", "knows", "can hide in an open field", "plays dead", "can preach at school", "has to eat the biggest bug", "can bug the bugs","cares the least","can't think","knows where to find me", "dines in the dump", "can take a lump with a dump", "takes the cat", "in the garden"];
